...
function Add_Color_Click_Handlers() {
	...
	jQuery('.ewd-uwcf-all-colors').on('click', function() {

		jQuery( '.ewd-uwcf-color' ).prop( 'checked', false ).trigger( 'change' );
...
function Add_Size_Click_Handlers() {
	...
	jQuery( '.ewd-uwcf-all-sizes' ).on( 'click', function() {

		jQuery( '.ewd-uwcf-size' ).prop( 'checked', false ).trigger( 'change' );
...
function Add_Category_Click_Handlers() {
	...
	jQuery( '.ewd-uwcf-all-categories' ).on( 'click', function() {

		jQuery( '.ewd-uwcf-category' ).prop( 'checked', false ).trigger( 'change' );
...
function Add_Tag_Click_Handlers() {
	...
	jQuery( '.ewd-uwcf-all-tags' ).on( 'click', function() {
		...
		jQuery('.ewd-uwcf-tag').prop('checked', false).trigger('change');
...
function Add_Attribute_Click_Handlers() {
	...
	jQuery( '.ewd-uwcf-all-attributes' ).on( 'click', function() {
		...
		jQuery( '.ewd-uwcf-attribute' ).prop( 'checked', false ).trigger( 'change' );
