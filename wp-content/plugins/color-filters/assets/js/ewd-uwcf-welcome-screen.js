jQuery(document).ready(function() {
	...
	jQuery('.ewd-uwcf-welcome-screen-save-table-mode-button').on('click', function() {
		...
		var data = 'table_mode=' + table_mode + '&action=ewd_uwcf_welcome_set_options';
	...
	jQuery('.ewd-uwcf-welcome-screen-save-options-button').on('click', function() {
		...
		var data = 'color_filtering=' + color_filtering + '&size_filtering=' + size_filtering + '&category_filtering=' + category_filtering + '&tag_filtering=' + tag_filtering + '&action=ewd_uwcf_welcome_set_options';
		jQuery.post(ajaxurl, data, function(response) {
	...
	jQuery('.ewd-uwcf-welcome-screen-add-color-button').on('click', function() {
		...
		var data = 'color_name=' + color_name + '&color_description=' + color_description + '&normal_fill=' + normal_fill + '&color_image=' + color_image + '&action=ewd_uwcf_welcome_add_color';
		jQuery.post(ajaxurl, data, function(response) {
	...
	jQuery('.ewd-uwcf-welcome-screen-add-size-button').on('click', function() {
		...
		var data = 'size_name=' + size_name + '&size_description=' + size_description + '&action=ewd_uwcf_welcome_add_size';
		jQuery.post(ajaxurl, data, function(response) {
