...
class ewduwcfViewProductFilters extends ewduwcfView {
	...
	public function maybe_print_color_filters() {
		...
		if ( ! $ewd_uwcf_controller->settings->get_setting( 'color-filtering-display-thumbnail-colors' ) ) { return; }
	...
	public function get_color_terms() {
		...
		return wp_get_post_terms( get_the_ID(), 'product_color' );
	}
	...
	public function maybe_print_size_filters() {
		...
		if ( ! $ewd_uwcf_controller->settings->get_setting( 'size-filtering-display-thumbnail-sizes' ) ) { return; }
	...
	public function get_size_terms() {
		...
		return wp_get_post_terms( get_the_ID(), 'product_size' );
	}
	...
	public function get_category_terms() {
		...
		return wp_get_post_terms( get_the_ID(), 'product_cat' );
	}
	...
	public function get_tag_terms() {
		...
		return wp_get_post_terms( get_the_ID(), 'product_tag' );
	}
	...
	public function get_attribute_terms() {
		...
		return wp_get_post_terms( get_the_ID(), 'pa_' . $this->current_attribute->attribute_name );
	}
