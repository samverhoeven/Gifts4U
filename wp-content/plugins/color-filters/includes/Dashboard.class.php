...
class ewduwcfDashboard {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_ewd_uwcf_hide_upgrade_box', array($this, 'hide_upgrade_box') );
		add_action( 'wp_ajax_ewd_uwcf_display_upgrade_box', array($this, 'display_upgrade_box') );
	}
				...
				<?php if ( ! $permission or get_option("EWD_UWCF_Trial_Happening") == "Yes" ) { ?>
					<div class="ewd-uwcf-dashboard-new-widget-box ewd-widget-box-full" id="ewd-uwcf-dashboard-get-premium-widget-box">
						...
						<div class="ewd-uwcf-dashboard-new-widget-box-bottom">
							...
							<a href="https://www.etoilewebdesign.com/license-payment/?Selected=UWCf&Quantity=1" class="ewd-uwcf-dashboard-get-premium-widget-button" target="_blank">UPGRADE NOW</a>
				...
				<!-- <div class="ewd-uwcf-dashboard-new-widget-box ewd-widget-box-full">
					...
					<div class="ewd-uwcf-dashboard-new-widget-box-bottom">
						<ul class="ewd-uwcf-dashboard-other-plugins">
							<li>
								<a href="https://wordpress.org/plugins/ultimate-product-catalogue/" target="_blank"><img src="<?php echo plugins_url( '../images/ewd-uwcf-icon.png', __FILE__ ); ?>"></a>
							...
							<li>
								<a href="https://wordpress.org/plugins/color-filters/" target="_blank"><img src="<?php echo plugins_url( '../images/ewd-uwcf-icon.png', __FILE__ ); ?>"></a>
								<div class="ewd-uwcf-dashboard-other-plugins-text">
									<div class="ewd-uwcf-dashboard-other-plugins-title">Ultimate WooCommerce Filters</div>
