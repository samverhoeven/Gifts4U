					...
					<div class="ewd-uwcf-deactivate-survey-options">
						<?php foreach ( $options as $id => $option ) : ?>
							<div class="ewd-uwcf-deactivate-survey-option">
								<label for="ewd-uwcf-deactivate-survey-option-color-filters-<?php echo $id; ?>" class="ewd-uwcf-deactivate-survey-option-label">
									<input id="ewd-uwcf-deactivate-survey-option-color-filters-<?php echo $id; ?>" class="ewd-uwcf-deactivate-survey-option-input" type="radio" name="code" value="<?php echo $id; ?>" />
